...
export default function Achievements() {
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary via-primary/95 to-primary/80 p-8 sm:p-12">
        ...
        <div className="relative">
          ...
          <p className="text-white/80 text-base leading-relaxed max-w-4xl mb-6">
            ...
            Онцлох төгсөгчид нэрээ дэвшүүлэх, гадаадын их дээд сургуульд дэвшин суралцах, болон
            сургуулийн захиргааны шагналд тодорхойлуулах, цаашлаад хөтөлбөр хэрэгжүүлэгч нэгжийн
      ...
      {/* Section 2: News + Video side by side */}
