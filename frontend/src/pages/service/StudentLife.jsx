    ...
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 text-white">
        ...
        <div className="flex flex-wrap items-center gap-4">
          <a
            href="tel:99023220"
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-gray-900 rounded-lg font-semibold hover:bg-gray-100 transition-colors shadow-sm border border-gray-200"
          >
          ...
          <a
            href="https://dormitory.ufe.edu.mn/"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-gray-900 rounded-lg font-semibold hover:bg-gray-100 transition-colors shadow-sm border border-gray-200"
          >
            Оюутны байрны мэдээлэл
          </a>
        </div>
